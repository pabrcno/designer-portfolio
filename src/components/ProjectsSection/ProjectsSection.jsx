...
const ProjectsSection = (props) => {
  return (
    <ProjectSection>
      <ProjectCard background="rgba(255,200,255, 0.8)" image={tasks} />
      <ProjectCard background="rgba(57,121,107, 0.8)" image={tso} />
      <ProjectCard background="rgba(240,240,240,0.8)" image={maImg} />
    </ProjectSection>
  );
};
